...
/**
 * Transformer that takes a string parameter and inserts it into target
 * class methods
 */
public class VariableTransformer extends Transformer {
    ...
    VariableTransformer(String className, ClassLoader classLoader,
            String insertString) {
     ...
     */
    @Override
    boolean instrument(CtMethod method)
